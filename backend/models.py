...
class PyTorchModel:
    ...
    def fit(self, X_train, y_train, val_split=0.2, batch_size=32, epochs=100, patience=10):
        """
        训练模型
...
def get_model(model_name, input_size):
    ...
    if model_name == "nn_classifier":
        net = NeuralClassifier(input_size)
        ...
        net = NeuralRegressor(input_size)
